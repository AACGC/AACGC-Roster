...
if (isset($_POST['update_user'])) {
        $message = ($sql->db_Update("aacgc_roster_members", "awarded_rank_id='".$_POST['awarded_rank_id']."', user_location='".$_POST['user_location']."', user_age='".$_POST['user_age']."', user_game='".$_POST['user_game']."', user_status='".$_POST['user_status']."', join_date='".$_POST['join_date']."' WHERE awarded_id='".$_POST['id']."' ")) ? "Successful updated" : "Update failed";
}

if (isset($_POST['main_delete'])) {
        $delete_id = array_keys($_POST['main_delete']);
	$sql2 = new db;
    $sql2->db_Delete("aacgc_roster_members", "awarded_id='".$delete_id[0]."'");
...
if ($action == "") {
        ...
        $sql->db_Select("aacgc_roster_members", "*", "ORDER BY awarded_id ASC","");
...
$text .= "<td style='width:' class='forumheader3'><img src='".e_PLUGIN."aacgc_roster/ranks/".$row2['rank_pic']."'></img></td>";
...
if ($action == "edit")
{
                $sql->db_Select("aacgc_roster_members", "*", "awarded_id = $id");
                $row = $sql->db_Fetch();
                $sql2 = new db;
                $sql2->db_Select("aacgc_roster", "*", "WHERE rank_id='".$row['awarded_rank_id']."'","");
                $row2 = $sql2->db_Fetch();
...
if ($pref['rank_enable_locflag'] == "1"){
        ...
        $iconpath = e_PLUGIN."/aacgc_roster/flags/";
...
$text .= "
        ...
        $sql5 = new db;
	$sql5->db_Select("aacgc_roster", "rank_id, rank_name", "ORDER BY rank_id ASC","");
