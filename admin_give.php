...
$sql->db_Insert("aacgc_roster_members", "NULL,'".$rankid."' , '".$uid."', '".$newuserloc."', '".$newuserage."', '".$newusergame."', '".$newuserstatus."', '".$newuserjoin."'");
...
<table style='width:60%' class='fborder' cellspacing='0' cellpadding='0'>
	<tr>
		...
		$sql->db_Select("aacgc_roster", "rank_id, rank_name", "ORDER BY rank_id ASC","");
        while($row = $sql->db_Fetch()){
...
$text .= "<tr>
		...
		<input class='button' type='submit' value='Give Rank To:' style='width:150px'>
	      ...
	      $ns -> tablerender("AACGC Roster (Give Rank)", $text);
